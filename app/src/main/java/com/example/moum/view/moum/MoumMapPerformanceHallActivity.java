...
//            finish();
        ...
        viewModel.getIsLoadPerformanceHallSuccess().observe(this, isLoadPerformanceHallSuccess -> {
            ...
            if (validation == Validation.PERFORMANCE_HALL_GET_SUCCESS) {
                ...
                if (loadedPerformanceHall.getDetails() != null) {
                    binding.textviewDescription.setText(loadedPerformanceHall.getDetails());
                }
                if (loadedPerformanceHall.getPrice() != null) {
                    binding.textviewPerformanceHallPrice.setText(
                            String.format("%,d", loadedPerformanceHall.getPrice()));
                }
                if (loadedPerformanceHall.getCapacity() != null) {
                    binding.textviewPerformanceHallCapacity.setText(
                            String.format("%d", loadedPerformanceHall.getCapacity()));
                }
                if (loadedPerformanceHall.getSize() != null) {
                    binding.textviewPerformanceHallSize.setText(
                            String.format("%d", loadedPerformanceHall.getSize()));
                }
                ...
                if (loadedPerformanceHall.getStand() != null) {
                    binding.textviewPerformanceHallStand.setText(
                            String.format("%d", loadedPerformanceHall.getStand()));
                }
                ...
                if (loadedPerformanceHall.getLatitude() != null && loadedPerformanceHall.getLongitude() != null) {
                    if (Boolean.TRUE.equals(viewModel.getIsNaverMapReady().getValue())) {
                        ...
                        CameraUpdate cameraUpdate = CameraUpdate.scrollTo(
                                new LatLng(loadedPerformanceHall.getLatitude(), loadedPerformanceHall.getLongitude()));
