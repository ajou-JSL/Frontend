...
public class MoumManageActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getIsLoadMoumSuccess().observe(this, isLoadMoumSuccess -> {
            ...
            if (validation == Validation.GET_MOUM_SUCCESS) {
                ...
                if (loadedMoum.getStartDate() != null && !loadedMoum.getStartDate().isEmpty() && loadedMoum.getEndDate() != null
                        && !loadedMoum.getEndDate().isEmpty()) {
                    binding.textviewMoumManageDate.setText(String.format("%s ~ %s", loadedMoum.getStartDate(), loadedMoum.getEndDate()));
                } else if (loadedMoum.getStartDate() != null && !loadedMoum.getStartDate().isEmpty() && (loadedMoum.getEndDate() == null
                        || loadedMoum.getEndDate().isEmpty())) {
                    binding.textviewMoumManageDate.setText(String.format("%s", loadedMoum.getStartDate()));
                } else if (loadedMoum.getEndDate() != null && !loadedMoum.getEndDate().isEmpty() && (loadedMoum.getStartDate() == null
                        || loadedMoum.getStartDate().isEmpty())) {
    ...
    public void onMoumDeleteDialogYesClicked() {
        viewModel.deleteMoum(moumId);
    }
