...
import com.example.moum.databinding.ActivityMoumPaymentChatroomBinding;
import com.example.moum.utils.SharedPreferenceManager;
import com.example.moum.utils.Validation;
import com.example.moum.view.auth.InitialActivity;
import com.example.moum.view.chat.adapter.ChatroomParticipantAdapter;
import com.example.moum.viewmodel.moum.MoumPaymentChatroomViewModel;

import java.util.ArrayList;

public class MoumPaymentChatroomActivity extends AppCompatActivity {
    private MoumPaymentChatroomViewModel viewModel;
    private ActivityMoumPaymentChatroomBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = ActivityMoumPaymentChatroomBinding.inflate(getLayoutInflater());
        viewModel = new ViewModelProvider(this).get(MoumPaymentChatroomViewModel.class);
