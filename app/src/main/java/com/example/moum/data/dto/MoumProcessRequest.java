...
public class MoumProcessRequest {
    ...
    public MoumProcessRequest(Boolean recruitStatus, Boolean chatroomStatus, Boolean practiceroomStatus, Boolean performLocationStatus, Boolean promoteStatus, Boolean paymentStatus){
